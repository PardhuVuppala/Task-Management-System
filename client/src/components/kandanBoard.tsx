...
function kandanBoard() {
  ...
  return (
    ...
    <div className='m-auto flex gap-4'>
        ...
        <button className='h-[60px] w-[350px], min-w-[350px] cursor-pointer rounded-lg
        bg-mainBackgroundColor border-2 border-columnBackgroundColor
        p-4 ring-rose-500 hover:ring-2 flex gap-2' onClick={()=>{createNewColumn()}}>
            <PlusIcon/> Add Column
        </button>
    </div>
...
function onDragOver(event:DragOverEvent)
{
    ...
    // dropping a task over anaother task
    if(isActiveTask && isOverTask)
    {
        ...
        //droppin a task over aver a coloumn
